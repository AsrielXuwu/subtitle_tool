...
# ================= 预设配置文件 =================
PRESET_FILE_REP = "column_presets.json"
PRESET_FILE_SPLIT = "split_presets.json"
PRESET_FILE_ASS = "ass_presets.json"
...
elif 'winnative' in style.theme_names(): style.theme_use('winnative')
...
nb_ass.add(tab_ass, text=" SRT 转 ASS 纯净版 ")
...
nb_ass.add(tab_ms, text=" 📂 SRT 分类合并转 ASS ")
...
nb_ass.add(tab_ass_split, text=" ✂️ ASS 拆分 (画面/普通) ")
...
# ================= TAB 11: ASS 样式预设提取 =================
tab_ext = ttk.Frame(nb_other, padding=20)
nb_other.add(tab_ext, text=" 📥 ASS 样式预设提取 ")
